...
$(document).ready(function () {
    var name, keyID,review="<h4>Review:</h4>",language,rating;
    keyID = sessionStorage.getItem("attractionKey");
   ...
   $.getJSON('http://tour-pedia.org/api/getPlaceDetails?id=' + keyID, function (data) {  
        ...
        </li><li class="list-group-item"><span class="badge">'+language+'</span>Language </li>\n\
        <li class="list-group-item"><span class="badge">'+rating+'</span>Rating </li></ul>';
        str+=review;     
         $('.fa-pulse').remove();
        $("h3").after(str);
    });
